 ...
 export function CommunitySidebar() {
   ...
   const navigation = [
     ...
     { name: "Classement", href: `/c/${slug}/leaderboard`, icon: Trophy },
     { name: "Calendrier", href: `/c/${slug}/calendar`, icon: Calendar },
   ];
           ...
           {profile && (
             <div className="mb-3 rounded-lg bg-sidebar-accent p-3">
               <div className="flex items-center justify-between text-xs text-sidebar-foreground">
                 ...
                 <span className="text-primary font-semibold">{profile.points} pts</span>
               </div>
