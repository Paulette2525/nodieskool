...
export default function CommunityAdmin() {
  ...
  const { 
    members, stats, courses, posts, isLoading,
    updateMemberRole, removeMember, deletePost,
  } = useCommunityAdmin();
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Gérez votre communauté {community?.name}</p>
      </div>
